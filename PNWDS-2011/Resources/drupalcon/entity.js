...
Drupal.entity.sites.main.types.node.schema = {
  ...
  defaultFetcher: function(bundle, store, func) {
    // Set the base URL.
    var url = 'http://pnwdrupalsummit.org/mobile/fetch/' + bundle;
...
Drupal.entity.sites.main.types.user.schema = {
   ...
   */
  defaultFetcher: function(bundle, store, func) {
    this.prototype.defaultFetcher.apply(this, [bundle, store, func, 'http://pnwdrupalsummit.org/mobile/fetch/presenters']);
  }
