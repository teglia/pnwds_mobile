...
MAKE_SYSTEM_PROP(ACTIVITY,UIPNWDSNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIPNWDSNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIPNWDSNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIPNWDSNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIPNWDSNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIPNWDSNativeItemContactAdd);
