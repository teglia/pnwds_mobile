...
// in simulator we redefine to format for PNWDS Developer console
...
{\
	NSString * exceptionName = [@"org.pnwds." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pnwds";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPNWDSNativeItemNone = -1, 
	UIPNWDSNativeItemSpinner = -2,
	UIPNWDSNativeItemProgressBar = -3,
	
	UIPNWDSNativeItemSlider = -4,
	UIPNWDSNativeItemSwitch = -5,
	UIPNWDSNativeItemMultiButton = -6,
	UIPNWDSNativeItemSegmented = -7,
	
	UIPNWDSNativeItemTextView = -8,
	UIPNWDSNativeItemTextField = -9,
	UIPNWDSNativeItemSearchBar = -10,
	
	UIPNWDSNativeItemPicker = -11,
	UIPNWDSNativeItemDatePicker = -12,
	
	UIPNWDSNativeItemInfoLight = -13,
	UIPNWDSNativeItemInfoDark = -14,
	
	UIPNWDSNativeItemDisclosure = -15,
	
	UIPNWDSNativeItemContactAdd = -16
};
