...
/**
 Base class for all Drupanium views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Drupanium view hierarchy (such as wrapped iOS UIViews) was touched.
