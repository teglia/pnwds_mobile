...
exports.newWin = function(navController, nid) {
  ...
  xhr.onload = function() {
  	...
  	if(statusCode == 200) {
  		...
  		var isFlaggedURL = Titanium.App.Properties.getString("restPath") + 'flag/is_flagged.json';
  		...
  		buttonsBar.addEventListener('click', function(e) {
  			...
  			// Clicked on the add comment button
  				...
  				var addCommentWin = Titanium.UI.createWindow({
  					title: 'Add comment',
  					backgroundColor: '#666',
  					url: '/includes/create-comment.js',
  					nid: data.nid,
  					touchEnabled: true,
  					animated: true,
  					modal: false,
  			...
  			// Clicked on bookmark this
  				...
  				var flagURL = Titanium.App.Properties.getString("restPath") + 'flag/flag.json';
